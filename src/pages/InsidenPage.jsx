...
import { KERAWANAN_CATEGORIES, hitungKerawananPos } from '../constants/kerawananCategories'
      ...
      <div className="flex-shrink-0 px-4 py-3"
        ...
        <div className="flex gap-1 mb-2 flex-wrap">
          {TIMELINE_OPTIONS.map(opt => (
            <button
              key={opt.id}
              onClick={() => setFilterTimeline(opt.id)}
              className="px-2.5 py-1 text-[9px] font-bold uppercase tracking-wider rounded-sm transition-all"
              style={filterTimeline === opt.id ? {
        ...
        <div className="flex flex-wrap gap-2">
          ...
          {/* Print/export */}
          <button
            className="hud-btn text-[9px] px-2 ml-auto"
